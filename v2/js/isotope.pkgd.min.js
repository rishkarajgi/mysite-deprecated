...
function (t) {
  ...
  e.isReady = !1,
  'function' == typeof define && define.amd ? (e.isReady = 'function' == typeof requirejs, define('doc-ready/doc-ready', [
    'eventie/eventie'
...
function (t) {
  ...
  ], o)  : 'object' == typeof exports ? module.exports = o(require('get-style-property'))  : t.getSize = o(t.getStyleProperty)
}(window),
function (t, e) {
  function i(t, e) {
    return t[a](e)
...
function (t) {
  ...
  function s(i, s, f, d, l, y) {
    ...
    m.prototype._filterFindItemElements = function (t) {
      t = o(t);
      for (var e = this.options.itemSelector, i = [
...
function (t) {
  ...
  function r(t, i, r, u, h) {
    ...
    c.prototype._filter = function (t) {
      ...
      ], s = this._getFilterTest(i), a = 0, u = t.length; u > a; a++) {
        var p = t[a];
        if (!p.isIgnored) {
          var h = s(p);
          h && o.push(p),
  ...
  'isotope/js/layout-modes/vertical'], r)  : t.Isotope = r(t.Outlayer, t.getSize, t.matchesSelector, t.Isotope.Item, t.Isotope.LayoutMode)
}(window);
